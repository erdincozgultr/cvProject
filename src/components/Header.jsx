      ...
      <div className="flex flex-col gap-y-5 text-lg font-medium">
        <div className="flex gap-x-6 flex justify-end item-center">
          <label className="inline-flex items-center cursor-pointer">
            ...
            <span className="ms-3 text-[#777777]">DARK MODE</span>
          </label>
          <span>|</span>
          <span className="text-[#4731d3]">
            TÜRKÇE<span className="text-[#777777]">'YE GEÇ</span>
          </span>
        </div>
        <div className="w-full flex justify-between items-center">
          <div className="flex">
            <button className="rotate-45 bg-[#eeebff] rounded-full w-16 h-16 text-[#4731d3]">
          ...
          <div className="flex gap-x-16 text-[#777777]">
            ...
            <button className="border-1 border-solid px-8 py-4 rounded-md text-[#4731d3]">
              Hire Me
            </button>
          </div>
        </div>
